          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="_header_nav_profile">
              <div className="_header_nav_profile_image">
                <img src={avatarSrc(user)} alt="Image" className="_nav_profile_img" />
              </div>
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para">{fullName(user)}</p>
                <button
              ...
              >
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <img src={avatarSrc(user)} alt="Image" className="_nav_drop_img" />
                  </div>
                  <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{fullName(user)}</h4>
